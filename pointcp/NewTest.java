	...
	public static void main(String[] args) throws IOException {
		...
		try {
			if (args[0].toUpperCase().charAt(0) == 'P') {
				point = new PointCP2(args[0].toUpperCase().charAt(0), Double.valueOf(args[1]).doubleValue(),
						Double.valueOf(args[2]).doubleValue());
			} else {

				point = new PointCP3(args[0].toUpperCase().charAt(0), Double.valueOf(args[1]).doubleValue(),
						Double.valueOf(args[2]).doubleValue());
			}
		...
		if (point.getType() == 'P') {
			...
			PointCP2 cp2 = point.convertStorageToPolar();
		...
		System.out.println(
				"The distance between two points (original point and new point) is " + point.getDistance(otherPoint));
